...
final class Utilities {
    ...
    static Drawable createIconThumbnail(Drawable icon, Context context) {
        if (sIconWidth == -1) {
            ...
            sIconWidth = sIconHeight = 64;
            
        }
        //System.out.println("sIconWidth=" + sIconWidth);
        ...
        if (icon instanceof PaintDrawable) {
            ...
            if (bitmap.getDensity() == Bitmap.DENSITY_NONE) {
                System.out.println("Bitmap.DENSITY_NONE");         	
                bitmapDrawable.setTargetDensity(context.getResources().getDisplayMetrics());
                System.out.println("Bitmap.DENSITY_NONE, using density " + context.getResources().getDisplayMetrics().density 
        ...
        if (width > 0 && height > 0) {
            if (width < iconWidth || height < iconHeight || scale != 1.0f) {
                ...
                System.out.println("))))))))) " + sIconWidth + " : " + sIconHeight);
                final Canvas canvas = sCanvas;
                canvas.setBitmap(thumb);
                sOldBounds.set(icon.getBounds());
