/*
O * Copyright (C) 2008 The Android Open Source Project
 *
...
Returns
boolean If true than the Drawable is being displayed in the view; else false and it is not allowed to animate.(non-Javadoc)
    ...
    //notify state change for repaint ?
    @Override
