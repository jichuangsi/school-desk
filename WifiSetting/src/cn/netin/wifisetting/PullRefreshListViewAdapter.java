...
public class PullRefreshListViewAdapter extends BaseAdapter {
    ...
    public PullRefreshListViewAdapter(Context context, List<ScanResult> datas) {
        super();
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (descOri.toUpperCase(Locale.ENGLISH).contains("WPA-PSK")) {
            desc = "WPA";
        }
        if (descOri.toUpperCase(Locale.ENGLISH).contains("WPA2-PSK")) {
            desc = "WPA2";
        }
        if (descOri.toUpperCase(Locale.ENGLISH).contains("WPA-PSK")
                && descOri.toUpperCase(Locale.ENGLISH).contains("WPA2-PSK")) {
            desc = "WPA/WPA2";
        }
