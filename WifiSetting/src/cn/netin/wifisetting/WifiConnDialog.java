...
public class WifiConnDialog extends Dialog {
    ...
    public WifiConnDialog(Context context, int theme, ListView mListView,
                          int mPosition, PullRefreshListViewAdapter mAdapter, ScanResult scanResult,
    ...
    private void setListener() {
        ...
        txtBtnConn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (scanResult.capabilities.toUpperCase(Locale.ENGLISH).contains("WPA")) {
                    type = WifiConnectUtils.WifiCipherType.WIFICIPHER_WPA;
                } else if (scanResult.capabilities.toUpperCase(Locale.ENGLISH)
                        .contains("WEP")) {
                ...
                // 去连接网络
                WifiUtils mWifiAdmin = new WifiUtils(context);
                /**是否去连接了 */
