...
public class ScrollTextView extends TextView {
	...
	private void initView() {
		...
		mAnimation = new AlphaAnimation(1,(float) 0.2);//实例化渐变动画 从显示渐变到隐藏
		mAnimation.setDuration(1000);//设置渐变时间
	...
	public void computeScroll() {
		...
		/**
		 * 隐藏
		 * @param delay 延迟 多少毫秒执行
		 */
		public void hide(int delay){
			mAnimation.setStartOffset(delay);//延迟 启动动画时间
			this.startAnimation(mAnimation);
